      ...
      <section className="bg-dark-radial pt-36 sm:pt-40">
        <div className="section-shell pb-16 pt-10">
          <SectionTitle
            align="left"
            eyebrow="Contact"
            title="Let’s talk about the future of accessible legal support."
            description="Reach out for partnerships, product questions, hiring conversations, or early access discussions."
          />
        </div>
      </section>
        ...
        <div className="section-shell grid gap-8 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          >
            ...
            <div className="mt-8 grid gap-4">
              <Info icon={Mail} label="Email" value="hello@verdits.com" />
            ...
            <div className="mt-8 flex gap-3">
              {[Linkedin, Twitter, Facebook].map((Icon, index) => (
                <a
                  key={index}
                  href="#"
                  className="flex h-11 w-11 items-center justify-center rounded-full border border-sky-100 bg-white text-verdits-text transition hover:border-verdits-teal/40 hover:bg-verdits-mint hover:text-verdits-navy"
...
function Info({ icon: Icon, label, value }) {
  return (
    <div className="flex items-center gap-4 rounded-2xl border border-sky-100 bg-verdits-section p-4">
